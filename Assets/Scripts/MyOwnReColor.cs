...
public class MyOwnReColor : MonoBehaviour
{
    ...
    {
        SetMaterial(selected1);
    }

    public void SetSelected2()
    {
        SetMaterial(selected2);
    }

    public void SetSelected3()
    {
        SetMaterial(selected3);
    }
